...
-   [Mozilla Mercurial Repository]
  ...
  [Netscape]: /wiki/Netscape "Netscape"
  [Mozilla Foundation]: /wiki/Mozilla_Foundation "Mozilla Foundation"
  [Mozilla Corporation]: /wiki/Mozilla_Corporation "Mozilla Corporation"
  [Mozilla produces many products]: /wiki/List_of_Mozilla_products "List of Mozilla products"
  [Firefox]: /wiki/Firefox "Firefox"
  [Thunderbird]: /wiki/Mozilla_Thunderbird "Mozilla Thunderbird"
  [Firefox Mobile]: /wiki/Firefox_Mobile "Firefox Mobile"
  [Firefox OS]: /wiki/Firefox_OS "Firefox OS"
  [Bugzilla]: /wiki/Bugzilla "Bugzilla"
  [Netscape Communicator]: /wiki/Netscape_Communicator "Netscape Communicator"
  [Jamie Zawinski]: /wiki/Jamie_Zawinski "Jamie Zawinski"
  [Netscape Navigator]: /wiki/Netscape_Navigator "Netscape Navigator"
  [Mosaic]: /wiki/Mosaic_(web_browser) "Mosaic (web browser)"
  [Godzilla]: /wiki/Godzilla "Godzilla"
  [Mozilla Application Suite]: /wiki/Mozilla_Application_Suite "Mozilla Application Suite"
  [open source]: /wiki/Open_source "Open source"
  [AOL]: /wiki/AOL "AOL"
  [Android]: /wiki/Android_(operating_system) "Android (operating system)"
  [Mozilla Persona]: /wiki/Mozilla_Persona "Mozilla Persona"
  [Cisco Systems]: /wiki/Cisco_Systems "Cisco Systems"
  [codec]: /wiki/Codec "Codec"
  [proprietary]: /wiki/Proprietary_format "Proprietary format"
  [H.264]: /wiki/H.264 "H.264"
  [Brendan Eich]: /wiki/Brendan_Eich "Brendan Eich"
  [California’s Proposition 8]: /wiki/California_Proposition_8_(2008) "California Proposition 8 (2008)"
  [OkCupid]: /wiki/OkCupid "OkCupid"
  [CREDO Mobile]: /wiki/CREDO_Mobile "CREDO Mobile"
  [Mitchell Baker]: /wiki/Mitchell_Baker "Mitchell Baker"
  [citation needed]: /wiki/Wikipedia:Citation_needed "Wikipedia:Citation needed"
  [Sam Yagan]: /wiki/Sam_Yagan "Sam Yagan"
  [Chris Cannon]: /wiki/Chris_Cannon "Chris Cannon"
  [JavaScript]: /wiki/Brendan_Eich#Netscape_and_JavaScript "Brendan Eich"
  [publicity stunt]: /wiki/Publicity_stunt "Publicity stunt"
  [1]: //upload.wikimedia.org/wikipedia/commons/thumb/7/76/Mozilla_Firefox_logo_2013.svg/220px-Mozilla_Firefox_logo_2013.svg.png
  [![][1]]: /wiki/File:Mozilla_Firefox_logo_2013.svg
  [web browser]: /wiki/Web_browser "Web browser"
  [flagship]: /wiki/Flagship_product "Flagship product"
  [Gecko]: /wiki/Gecko_(software) "Gecko (software)"
  [layout engine]: /wiki/Layout_engine "Layout engine"
  [web standards]: /wiki/Web_standards "Web standards"
  [\[update\]]: //en.wikipedia.org/w/index.php?title=Mozilla&action=edit
  [usage share of web browsers]: /wiki/Usage_share_of_web_browsers#Summary "Usage share of web browsers"
  [Mozilla codebase]: /wiki/Mozilla#Mozilla_Project "Mozilla"
  [Dave Hyatt]: /wiki/Dave_Hyatt "Dave Hyatt"
  [Joe Hewitt]: /wiki/Joe_Hewitt_(programmer) "Joe Hewitt (programmer)"
  [Blake Ross]: /wiki/Blake_Ross "Blake Ross"
  [feature creep]: /wiki/Feature_creep "Feature creep"
  [software bloat]: /wiki/Software_bloat "Software bloat"
  [Phoenix Technologies]: /wiki/Phoenix_Technologies "Phoenix Technologies"
  [Firebird]: /wiki/Firebird_(database_server) "Firebird (database server)"
  [smartphones]: /wiki/Smartphone "Smartphone"
  [tablet computers]: /wiki/Tablet_computer "Tablet computer"
  [2]: /wiki/Gecko_(layout_engine) "Gecko (layout engine)"
  [HTML5]: /wiki/HTML5 "HTML5"
  [Firefox Sync]: /wiki/Firefox_Sync "Firefox Sync"
  [add-ons]: /wiki/Add-on_(Mozilla) "Add-on (Mozilla)"
  [tabbed browsing]: /wiki/Tabbed_browsing "Tabbed browsing"
  [ARMv7]: /wiki/ARM_architecture "ARM architecture"
  [Tristan Nitot]: /wiki/Tristan_Nitot "Tristan Nitot"
  [Mozilla Europe]: /wiki/Mozilla_Europe "Mozilla Europe"
  [iPhone]: /wiki/IPhone "IPhone"
  [BlackBerry]: /wiki/BlackBerry "BlackBerry"
  [Apple’s]: /wiki/Apple_Inc "Apple Inc"
  [operating system]: /wiki/Operating_system "Operating system"
  [open Web]: /wiki/Open_Web "Open Web"
  [APIs]: /wiki/Application_programming_interface "Application programming interface"
  [3]: /wiki/JavaScript "JavaScript"
  [4]: //upload.wikimedia.org/wikipedia/commons/0/0d/SeaMonkey.png
  [![][4]]: /wiki/File:SeaMonkey.png
  [SeaMonkey]: /wiki/SeaMonkey "SeaMonkey"
  [USENET]: /wiki/USENET "USENET"
  [Mozilla Composer]: /wiki/Mozilla_Composer "Mozilla Composer"
  [ChatZilla]: /wiki/ChatZilla "ChatZilla"
  [the Mozilla Foundation]: /wiki/The_Mozilla_Foundation "The Mozilla Foundation"
  [5]: /wiki/Mozilla_Firefox "Mozilla Firefox"
  [trademarked]: /wiki/Trademark "Trademark"
  [6]: //upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Buggie.svg/220px-Buggie.svg.png
  [![][6]]: /wiki/File:Buggie.svg
  [web]: /wiki/World_Wide_Web "World Wide Web"
  [bug tracking system]: /wiki/Bug_tracking_system "Bug tracking system"
  [open source software]: /wiki/Open_source_software "Open source software"
  [Netscape Communications]: /wiki/Netscape_Communications "Netscape Communications"
  [free and open source software]: /wiki/Free_and_open_source_software "Free and open source software"
  [7]: /wiki/Proprietary_software "Proprietary software"
  [Linux kernel]: /wiki/Linux_kernel "Linux kernel"
  [GNOME]: /wiki/GNOME "GNOME"
  [KDE]: /wiki/KDE "KDE"
  [Red Hat]: /wiki/Red_Hat "Red Hat"
  [Novell]: /wiki/Novell "Novell"
  [Eclipse]: /wiki/Eclipse_(software) "Eclipse (software)"
  [LibreOffice]: /wiki/LibreOffice "LibreOffice"
  [Network Security Services]: /wiki/Network_Security_Services "Network Security Services"
  [libraries]: /wiki/Library_(computing) "Library (computing)"
  [cross-platform]: /wiki/Cross-platform "Cross-platform"
  [SSL]: /wiki/Secure_Sockets_Layer "Secure Sockets Layer"
  [S/MIME]: /wiki/S/MIME "S/MIME"
  [tri-licensed]: /wiki/Multi-licensing "Multi-licensing"
  [Mozilla Public License]: /wiki/Mozilla_Public_License "Mozilla Public License"
  [GNU General Public License]: /wiki/GNU_General_Public_License "GNU General Public License"
  [GNU Lesser General Public License]: /wiki/LGPL "LGPL"
  [Sun Microsystems]: /wiki/Sun_Microsystems "Sun Microsystems"
  [Oracle Corporation]: /wiki/Oracle_Corporation "Oracle Corporation"
  [Google]: /wiki/Google "Google"
  [Evolution]: /wiki/Evolution_(software) "Evolution (software)"
  [Pidgin]: /wiki/Pidgin_(software) "Pidgin (software)"
  [Apache OpenOffice]: /wiki/Apache_OpenOffice "Apache OpenOffice"
  [SpiderMonkey]: /wiki/SpiderMonkey_(software) "SpiderMonkey (software)"
  [JavaScript engine]: /wiki/JavaScript_engine "JavaScript engine"
  [C++]: /wiki/C%2B%2B "C++"
  [ECMAScript]: /wiki/ECMAScript "ECMAScript"
  [interpreter]: /wiki/Interpreter_(computing) "Interpreter (computing)"
  [just-in-time compilers]: /wiki/Just-in-time_compilation "Just-in-time compilation"
  [decompiler]: /wiki/Decompiler "Decompiler"
  [garbage collector]: /wiki/Garbage_collection_(computer_science) "Garbage collection (computer science)"
  [Java]: /wiki/Java_(programming_language) "Java (programming language)"
  [classes]: /wiki/Class_(computer_programming) "Class (computer programming)"
  [compiled]: /wiki/Compiler "Compiler"
  [8]: /wiki/Web_browser_engine "Web browser engine"
  [HTML]: /wiki/HTML "HTML"
  [SVG]: /wiki/Scalable_Vector_Graphics "Scalable Vector Graphics"
  [MathML]: /wiki/MathML "MathML"
  [NSPR]: /wiki/NSPR "NSPR"
  [platform independence]: /wiki/Platform_independence "Platform independence"
  [user interface]: /wiki/User_interface "User interface"
  ...
  [Servo]: /wiki/Servo_(layout_engine) "Servo (layout engine)"
  [XULRunner]: /wiki/XULRunner "XULRunner"
  [Pdf.js]: /wiki/Pdf.js "Pdf.js"
  [Shumway]: /wiki/Shumway_(software) "Shumway (software)"
  [Virtual reality]: /wiki/Virtual_reality "Virtual reality"
  [A-Frame (VR)]: /wiki/A-Frame_(VR) "A-Frame (VR)"
  [WebVR]: /wiki/WebVR "WebVR"
  [authentication]: /wiki/Authentication "Authentication"
  [Mozilla Developer Network]: /wiki/Mozilla_Developer_Network "Mozilla Developer Network"
  [CSS]: /wiki/CSS "CSS"
  [9]: /wiki/SVG "SVG"
  [10]: //upload.wikimedia.org/wikipedia/commons/thumb/2/2a/London_Mozilla_Workspace.jpg/220px-London_Mozilla_Workspace.jpg
  [![][10]]: /wiki/File:London_Mozilla_Workspace.jpg
  [11]: //upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Mozilla_Reps.png/220px-Mozilla_Reps.png
  [![][11]]: /wiki/File:Mozilla_Reps.png
  [12]: //upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Fireside_Chat%2C_Knight%27s_Michael_Maness_and_Dan_Sinker_-_Flickr_-_Knight_Foundation.jpg/220px-Fireside_Chat%2C_Knight%27s_Michael_Maness_and_Dan_Sinker_-_Flickr_-_Knight_Foundation.jpg
  [![][12]]: /wiki/File:Fireside_Chat,_Knight%27s_Michael_Maness_and_Dan_Sinker_-_Flickr_-_Knight_Foundation.jpg
  [Knight Foundation]: /wiki/Knight_Foundation "Knight Foundation"
  [-zilla (suffix)]: /wiki/-zilla_(suffix) "-zilla (suffix)"
  [Mozilla (mascot)]: /wiki/Mozilla_(mascot) "Mozilla (mascot)"
  [The Book of Mozilla]: /wiki/The_Book_of_Mozilla "The Book of Mozilla"
  [Timeline of web browsers]: /wiki/Timeline_of_web_browsers "Timeline of web browsers"
  ...
  [*Marc Andreessen and Jim Clark: The Founders of Netscape*]: //books.google.co.uk/books?id=zyIvOn7sKCsC
  [ISBN]: /wiki/International_Standard_Book_Number "International Standard Book Number"
  [9781404207196]: /wiki/Special:BookSources/9781404207196 "Special:BookSources/9781404207196"
  ...
  [link]: /wiki/Category:CS1_maint:_Unfit_url "Category:CS1 maint: Unfit url"
  ...
  [Goodger, Ben]: /wiki/Ben_Goodger "Ben Goodger"
  ...
  [CNET]: /wiki/CNET_Networks "CNET Networks"
  ...
  [15]: //upload.wikimedia.org/wikipedia/en/thumb/4/4a/Commons-logo.svg/30px-Commons-logo.svg.png
  [![][15]]: /wiki/File:Commons-logo.svg
