...
On March 10, 2005, [the Mozilla Foundation] announced that it would not release any official versions of Mozilla Application Suite beyond 1.7.x, since it had now focused on the standalone applications [Firefox][3] and [Thunderbird].^\[57\]^ SeaMonkey is now maintained by the SeaMonkey Council, which has [trademarked] the SeaMonkey name with help from the Mozilla Foundation.^\[58\]^ The Mozilla Foundation provides project hosting for the SeaMonkey developers.

### Bugzilla

[Bugzilla] is a [web]-based general-purpose [bug tracking system], which was released as [open source software] by [Netscape Communications] in 1998 along with the rest of the Mozilla codebase, and is currently stewarded by Mozilla. It has been adopted by a variety of organizations for use as a [bug tracking system] for both [free and open source software] and [proprietary][4] projects and products, including the [Mozilla Foundation][the Mozilla Foundation], the [Linux kernel], [GNOME], [KDE], [Red Hat], [Novell], [Eclipse] and [LibreOffice].^\[59\]^
...
[Gecko][1] is a [layout engine][5] that supports web pages written using [HTML], [SVG], and [MathML]. Gecko is written in [C++] and uses [NSPR] for [platform independence]. Its source code is licensed under the [Mozilla Public License].
...
Mozilla maintains a comprehensive developer documentation website called the [Mozilla Developer Network] which contains information about web technologies including [HTML], [CSS], [SVG][6], [JavaScript][2], as well Mozilla-specific information. In addition, Mozilla publishes a large number of videos about web technologies and the development of Mozilla projects on the Air Mozilla website.^\[71\]\[72\]^
...
-   [Mozilla Mercurial Repository]
  ...
  [Netscape]: file:///wiki/Netscape "Netscape"
  [Mozilla Foundation]: file:///wiki/Mozilla_Foundation "Mozilla Foundation"
  [Mozilla Corporation]: file:///wiki/Mozilla_Corporation "Mozilla Corporation"
  [Mozilla produces many products]: file:///wiki/List_of_Mozilla_products "List of Mozilla products"
  [Firefox]: file:///wiki/Firefox "Firefox"
  [Thunderbird]: file:///wiki/Mozilla_Thunderbird "Mozilla Thunderbird"
  [Firefox Mobile]: file:///wiki/Firefox_Mobile "Firefox Mobile"
  [Firefox OS]: file:///wiki/Firefox_OS "Firefox OS"
  [Bugzilla]: file:///wiki/Bugzilla "Bugzilla"
  [Netscape Communicator]: file:///wiki/Netscape_Communicator "Netscape Communicator"
  [Jamie Zawinski]: file:///wiki/Jamie_Zawinski "Jamie Zawinski"
  [Netscape Navigator]: file:///wiki/Netscape_Navigator "Netscape Navigator"
  [Mosaic]: file:///wiki/Mosaic_(web_browser) "Mosaic (web browser)"
  [Godzilla]: file:///wiki/Godzilla "Godzilla"
  [Mozilla Application Suite]: file:///wiki/Mozilla_Application_Suite "Mozilla Application Suite"
  [open source]: file:///wiki/Open_source "Open source"
  [AOL]: file:///wiki/AOL "AOL"
  [Android]: file:///wiki/Android_(operating_system) "Android (operating system)"
  [Mozilla Persona]: file:///wiki/Mozilla_Persona "Mozilla Persona"
  [Cisco Systems]: file:///wiki/Cisco_Systems "Cisco Systems"
  [codec]: file:///wiki/Codec "Codec"
  [proprietary]: file:///wiki/Proprietary_format "Proprietary format"
  [H.264]: file:///wiki/H.264 "H.264"
  [Brendan Eich]: file:///wiki/Brendan_Eich "Brendan Eich"
  [California’s Proposition 8]: file:///wiki/California_Proposition_8_(2008) "California Proposition 8 (2008)"
  ...
  [layout engine]: file:///wiki/Layout_engine "Layout engine"
  [web standards]: file:///wiki/Web_standards "Web standards"
  [\[update\]]: file://en.wikipedia.org/w/index.php?title=Mozilla&action=edit
  [usage share of web browsers]: file:///wiki/Usage_share_of_web_browsers#Summary "Usage share of web browsers"
  [Mozilla codebase]: file:///wiki/Mozilla#Mozilla_Project "Mozilla"
  [Dave Hyatt]: file:///wiki/Dave_Hyatt "Dave Hyatt"
  [Joe Hewitt]: file:///wiki/Joe_Hewitt_(programmer) "Joe Hewitt (programmer)"
  [Blake Ross]: file:///wiki/Blake_Ross "Blake Ross"
  [feature creep]: file:///wiki/Feature_creep "Feature creep"
  [software bloat]: file:///wiki/Software_bloat "Software bloat"
  [Phoenix Technologies]: file:///wiki/Phoenix_Technologies "Phoenix Technologies"
  ...
  [tabbed browsing]: file:///wiki/Tabbed_browsing "Tabbed browsing"
  [ARMv7]: file:///wiki/ARM_architecture "ARM architecture"
  [Tristan Nitot]: file:///wiki/Tristan_Nitot "Tristan Nitot"
  [Mozilla Europe]: file:///wiki/Mozilla_Europe "Mozilla Europe"
  [iPhone]: file:///wiki/IPhone "IPhone"
  [BlackBerry]: file:///wiki/BlackBerry "BlackBerry"
  [Apple’s]: file:///wiki/Apple_Inc "Apple Inc"
  ...
  [3]: file:///wiki/Mozilla_Firefox "Mozilla Firefox"
  ...
  [4]: file:///wiki/Proprietary_software "Proprietary software"
  [Linux kernel]: file:///wiki/Linux_kernel "Linux kernel"
  [GNOME]: file:///wiki/GNOME "GNOME"
  [KDE]: file:///wiki/KDE "KDE"
  [Red Hat]: file:///wiki/Red_Hat "Red Hat"
  [Novell]: file:///wiki/Novell "Novell"
  [Eclipse]: file:///wiki/Eclipse_(software) "Eclipse (software)"
  [LibreOffice]: file:///wiki/LibreOffice "LibreOffice"
  [Network Security Services]: file:///wiki/Network_Security_Services "Network Security Services"
  [libraries]: file:///wiki/Library_(computing) "Library (computing)"
  [cross-platform]: file:///wiki/Cross-platform "Cross-platform"
  [SSL]: file:///wiki/Secure_Sockets_Layer "Secure Sockets Layer"
  [S/MIME]: file:///wiki/S/MIME "S/MIME"
  [tri-licensed]: file:///wiki/Multi-licensing "Multi-licensing"
  [Mozilla Public License]: file:///wiki/Mozilla_Public_License "Mozilla Public License"
  [GNU General Public License]: file:///wiki/GNU_General_Public_License "GNU General Public License"
  [GNU Lesser General Public License]: file:///wiki/LGPL "LGPL"
  [Sun Microsystems]: file:///wiki/Sun_Microsystems "Sun Microsystems"
  [Oracle Corporation]: file:///wiki/Oracle_Corporation "Oracle Corporation"
  [Google]: file:///wiki/Google "Google"
  [Evolution]: file:///wiki/Evolution_(software) "Evolution (software)"
  [Pidgin]: file:///wiki/Pidgin_(software) "Pidgin (software)"
  [Apache OpenOffice]: file:///wiki/Apache_OpenOffice "Apache OpenOffice"
  [SpiderMonkey]: file:///wiki/SpiderMonkey_(software) "SpiderMonkey (software)"
  [JavaScript engine]: file:///wiki/JavaScript_engine "JavaScript engine"
  [C++]: file:///wiki/C%2B%2B "C++"
  [ECMAScript]: file:///wiki/ECMAScript "ECMAScript"
  [interpreter]: file:///wiki/Interpreter_(computing) "Interpreter (computing)"
  [just-in-time compilers]: file:///wiki/Just-in-time_compilation "Just-in-time compilation"
  [decompiler]: file:///wiki/Decompiler "Decompiler"
  [garbage collector]: file:///wiki/Garbage_collection_(computer_science) "Garbage collection (computer science)"
  ...
  [5]: file:///wiki/Web_browser_engine "Web browser engine"
  [HTML]: file:///wiki/HTML "HTML"
  [SVG]: file:///wiki/Scalable_Vector_Graphics "Scalable Vector Graphics"
  [MathML]: file:///wiki/MathML "MathML"
  [NSPR]: file:///wiki/NSPR "NSPR"
  [platform independence]: file:///wiki/Platform_independence "Platform independence"
  [user interface]: file:///wiki/User_interface "User interface"
  [Rust]: file:///wiki/Rust_(programming_language) "Rust (programming language)"
  [programming language]: file:///wiki/Programming_language "Programming language"
  [Servo]: file:///wiki/Servo_(layout_engine) "Servo (layout engine)"
  [XULRunner]: file:///wiki/XULRunner "XULRunner"
  [Pdf.js]: file:///wiki/Pdf.js "Pdf.js"
  [Shumway]: file:///wiki/Shumway_(software) "Shumway (software)"
  [Virtual reality]: file:///wiki/Virtual_reality "Virtual reality"
  [A-Frame (VR)]: file:///wiki/A-Frame_(VR) "A-Frame (VR)"
  [WebVR]: file:///wiki/WebVR "WebVR"
  ...
  [The Book of Mozilla]: file:///wiki/The_Book_of_Mozilla "The Book of Mozilla"
  [Timeline of web browsers]: file:///wiki/Timeline_of_web_browsers "Timeline of web browsers"
  ...
  [*Marc Andreessen and Jim Clark: The Founders of Netscape*]: file://books.google.co.uk/books?id=zyIvOn7sKCsC
  [ISBN]: file:///wiki/International_Standard_Book_Number "International Standard Book Number"
  [9781404207196]: file:///wiki/Special:BookSources/9781404207196 "Special:BookSources/9781404207196"
  ...
  [7]: http://weblogs.mozillazine.org/ben/archives/009698.html
  ...
  [8]: http://www.ibphoenix.com/main.nfs?a=ibphoenix&page=ibp_Mozilla0
  ...
  [Mozilla Mercurial Repository]: file://hg.mozilla.org/
